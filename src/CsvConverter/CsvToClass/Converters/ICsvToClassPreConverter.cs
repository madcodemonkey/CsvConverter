...
namespace CsvConverter.CsvToClass
{
    ...
    {
        /// <summary>This method is called to make sure that the pre-converter can handle the string when the
        /// target class property is of theType.  If it returns false, a pre-converter of this type is NOT
