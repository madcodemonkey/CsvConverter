namespace CsvConverter.Core.Tests.Attributes
{
    ...
    public class PropertyLevelAttributeOrderWriteTests
    {
        ...
        public void Convert_OrderMatters_FirstRemoveSpacesAndThenDoExactMatch(
            string animalTypeInput, string animalTypeExpectedOutput)
        {
            // Arrange
            ...
            var data = new PropLevelAttributeOrderWriteData1() { AnimalType = animalTypeInput };
            ...
            Assert.AreEqual(animalTypeExpectedOutput, dataRow[0]);
        }
      ...
      string animalTypeInput, string animalTypeExpectedOutput)
        {
            ...
            var data = new PropLevelAttributeOrderWriteData2() { AnimalType = animalTypeInput };
